...
$"std_hash_siphash$ulong$2$4$.SipHash.init" = comdat any

$"std_hash_siphash$ulong$2$4$.SipHash.update" = comdat any

$"std_hash_siphash$ulong$2$4$.SipHash.final" = comdat any

$"std_hash_siphash$ulong$2$4$.hash" = comdat any

$"$ct.std_hash_siphash$ulong$2$4$.SipHash" = comdat any

$"std_hash_siphash$ulong$2$4$.BLOCK_ROUNDS" = comdat any

$"std_hash_siphash$ulong$2$4$.FINALIZE_ROUNDS" = comdat any

$"$ct.ulong" = comdat any

$"$ct.long" = comdat any

@"$ct.std_hash_siphash$ulong$2$4$.SipHash" = linkonce global %.introspect { i8 10, i64 0, ptr null, i64 56, i64 0, i64 4, [0 x i64] zeroinitializer }, comdat, align 8
@"std_hash_siphash$ulong$2$4$.BLOCK_ROUNDS" = weak_odr local_unnamed_addr constant i32 2, comdat, align 4, !dbg !0
@"std_hash_siphash$ulong$2$4$.FINALIZE_ROUNDS" = weak_odr local_unnamed_addr constant i32 4, comdat, align 4, !dbg !4
...
define weak_odr void @"std_hash_siphash$ulong$2$4$.SipHash.init"(ptr %0, ptr align 16 %1) #0 comdat !dbg !14 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define weak_odr void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %0, ptr align 8 %1) #0 comdat !dbg !50 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
if.exit:                                          ; preds = %checkok36
  ...
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %29), !dbg !74
  %30 = load ptr, ptr %self, align 8, !dbg !74
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %30), !dbg !74
...
; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @"std_hash_siphash$ulong$2$4$.SipHash.final"(ptr %0) #0 comdat !dbg !78 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
checkok41:                                        ; preds = %checkok29
  ...
  call void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %14, ptr align 8 %indirectarg43), !dbg !90
  ...
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %17), !dbg !92
  %18 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %18), !dbg !92
  %19 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %19), !dbg !92
  %20 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %20), !dbg !92
  %21 = load ptr, ptr %self, align 8, !dbg !93
  %22 = load i64, ptr %21, align 8, !dbg !93
  %23 = load ptr, ptr %self, align 8, !dbg !93
  %ptradd45 = getelementptr inbounds i8, ptr %23, i64 8, !dbg !93
  %24 = load i64, ptr %ptradd45, align 8, !dbg !93
  %xor46 = xor i64 %22, %24, !dbg !93
  %25 = load ptr, ptr %self, align 8, !dbg !93
  %ptradd47 = getelementptr inbounds i8, ptr %25, i64 16, !dbg !93
  %26 = load i64, ptr %ptradd47, align 8, !dbg !93
  %xor48 = xor i64 %xor46, %26, !dbg !93
  %27 = load ptr, ptr %self, align 8, !dbg !93
  %ptradd49 = getelementptr inbounds i8, ptr %27, i64 24, !dbg !93
  %28 = load i64, ptr %ptradd49, align 8, !dbg !93
  %xor50 = xor i64 %xor48, %28, !dbg !93
...
panic:                                            ; preds = %entry
  ...
  call void %29(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 113) #5, !dbg !84
  unreachable, !dbg !84
...
panic13:                                          ; preds = %cond.phi
  ...
  store %any %33, ptr %ptradd18, align 16
...
panic21:                                          ; preds = %checkok20
  ...
  %35 = insertvalue %any undef, ptr %taddr22, 0
  ...
  %37 = insertvalue %"any[]" undef, ptr %varargslots26, 0
  %"$$temp27" = insertvalue %"any[]" %37, i64 1, 1
...
panic31:                                          ; preds = %checkok29
  ...
  store %any %41, ptr %ptradd38, align 16
  %42 = insertvalue %"any[]" undef, ptr %varargslots37, 0
  %"$$temp39" = insertvalue %"any[]" %42, i64 2, 1
...
; Function Attrs: nounwind ssp uwtable
define internal void @"std_hash_siphash$ulong$2$4$.SipHash.round"(ptr %0) #0 !dbg !94 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @"std_hash_siphash$ulong$2$4$.hash"(ptr align 8 %0, ptr align 16 %1) #0 comdat !dbg !127 {
entry:
  %s = alloca %SipHash, align 8
  %indirectarg = alloca i128, align 16
  %indirectarg1 = alloca %"char[]", align 8
    #dbg_declare(ptr %0, !130, !DIExpression(), !131)
    #dbg_declare(ptr %1, !132, !DIExpression(), !131)
    #dbg_declare(ptr %s, !133, !DIExpression(), !134)
  call void @llvm.memset.p0.i64(ptr align 8 %s, i8 0, i64 56, i1 false), !dbg !134
  %2 = load i128, ptr %1, align 16
  store i128 %2, ptr %indirectarg, align 16
  call void @"std_hash_siphash$ulong$2$4$.SipHash.init"(ptr %s, ptr align 16 %indirectarg), !dbg !135
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %indirectarg1, ptr align 8 %0, i32 16, i1 false)
  call void @"std_hash_siphash$ulong$2$4$.SipHash.update"(ptr %s, ptr align 8 %indirectarg1), !dbg !136
  %3 = call i64 @"std_hash_siphash$ulong$2$4$.SipHash.final"(ptr %s), !dbg !137
  ret i64 %3, !dbg !137
}
...
!1 = distinct !DIGlobalVariable(name: "BLOCK_ROUNDS", linkageName: "std_hash_siphash$ulong$2$4$.BLOCK_ROUNDS", scope: !2, file: !2, line: 27, type: !3, isLocal: false, isDefinition: true, align: 4)
!2 = !DIFile(filename: "siphash.c3", directory: "C:/Compilers/C3/lib/std/hash")
!3 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!4 = !DIGlobalVariableExpression(var: !5, expr: !DIExpression())
!5 = distinct !DIGlobalVariable(name: "FINALIZE_ROUNDS", linkageName: "std_hash_siphash$ulong$2$4$.FINALIZE_ROUNDS", scope: !2, file: !2, line: 27, type: !3, isLocal: false, isDefinition: true, align: 4)
...
!13 = !{!0, !4}
!14 = distinct !DISubprogram(name: "init", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.init", scope: !2, file: !2, line: 70, type: !15, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!50 = distinct !DISubprogram(name: "update", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.update", scope: !2, file: !2, line: 89, type: !51, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!78 = distinct !DISubprogram(name: "final", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.final", scope: !2, file: !2, line: 113, type: !79, scopeLine: 113, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
!79 = !DISubroutineType(types: !80)
!80 = !{!81, !17}
!81 = !DIDerivedType(tag: DW_TAG_typedef, name: "OutType", scope: !2, file: !2, line: 27, baseType: !22, align: 8)
...
!94 = distinct !DISubprogram(name: "round", linkageName: "std_hash_siphash$ulong$2$4$.SipHash.round", scope: !2, file: !2, line: 145, type: !95, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!127 = distinct !DISubprogram(name: "hash", linkageName: "std_hash_siphash$ulong$2$4$.hash", scope: !2, file: !2, line: 62, type: !128, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
!128 = !DISubroutineType(types: !129)
!129 = !{!81, !53, !30}
!130 = !DILocalVariable(name: "data", arg: 1, scope: !127, file: !2, line: 62, type: !53)
!131 = !DILocation(line: 62, scope: !127)
!132 = !DILocalVariable(name: "key", arg: 2, scope: !127, file: !2, line: 62, type: !30)
!133 = !DILocalVariable(name: "s", scope: !127, file: !2, line: 64, type: !18, align: 8)
!134 = !DILocation(line: 64, scope: !127)
!135 = !DILocation(line: 65, scope: !127)
!136 = !DILocation(line: 66, scope: !127)
!137 = !DILocation(line: 67, scope: !127)
