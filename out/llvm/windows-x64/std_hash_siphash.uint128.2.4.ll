...
$"std_hash_siphash$uint128$2$4$.SipHash.init" = comdat any

$"std_hash_siphash$uint128$2$4$.SipHash.update" = comdat any

$"std_hash_siphash$uint128$2$4$.SipHash.final" = comdat any

$"std_hash_siphash$uint128$2$4$.hash" = comdat any

$"$ct.std_hash_siphash$uint128$2$4$.SipHash" = comdat any

$"std_hash_siphash$uint128$2$4$.BLOCK_ROUNDS" = comdat any

$"std_hash_siphash$uint128$2$4$.FINALIZE_ROUNDS" = comdat any

$"$ct.ulong" = comdat any

$"$ct.long" = comdat any

@"$ct.std_hash_siphash$uint128$2$4$.SipHash" = linkonce global %.introspect { i8 10, i64 0, ptr null, i64 56, i64 0, i64 4, [0 x i64] zeroinitializer }, comdat, align 8
@"std_hash_siphash$uint128$2$4$.BLOCK_ROUNDS" = weak_odr local_unnamed_addr constant i32 2, comdat, align 4, !dbg !0
@"std_hash_siphash$uint128$2$4$.FINALIZE_ROUNDS" = weak_odr local_unnamed_addr constant i32 4, comdat, align 4, !dbg !4
...
define weak_odr void @"std_hash_siphash$uint128$2$4$.SipHash.init"(ptr %0, ptr align 16 %1) #0 comdat !dbg !14 {
entry:
...
; Function Attrs: nounwind ssp uwtable
define weak_odr void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %0, ptr align 8 %1) #0 comdat !dbg !50 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
if.exit:                                          ; preds = %checkok36
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %29), !dbg !74
  %30 = load ptr, ptr %self, align 8, !dbg !74
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %30), !dbg !74
  %31 = load ptr, ptr %self, align 8, !dbg !75
  %32 = load i64, ptr %31, align 8, !dbg !75
  %33 = load ptr, ptr %self, align 8, !dbg !75
  %ptradd42 = getelementptr inbounds i8, ptr %33, i64 32, !dbg !75
  %34 = load i64, ptr %ptradd42, align 8, !dbg !75
  %xor43 = xor i64 %32, %34, !dbg !75
  store i64 %xor43, ptr %31, align 8, !dbg !75
  %35 = load ptr, ptr %self, align 8, !dbg !76
  %ptradd44 = getelementptr inbounds i8, ptr %35, i64 40, !dbg !76
  store i32 0, ptr %ptradd44, align 8, !dbg !76
  %36 = load ptr, ptr %self, align 8, !dbg !77
  %ptradd45 = getelementptr inbounds i8, ptr %36, i64 32, !dbg !77
  store i64 0, ptr %ptradd45, align 8, !dbg !77
  br label %loop.inc, !dbg !77

loop.inc:                                         ; preds = %if.exit, %if.then
  %37 = load i64, ptr %.anon, align 8, !dbg !64
  %addnuw = add nuw i64 %37, 1, !dbg !64
...
panic:                                            ; preds = %entry
  ...
  call void %38(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 89) #5, !dbg !61
  unreachable, !dbg !61
...
panic28:                                          ; preds = %checkok27
  ...
  store %any %48, ptr %varargslots33, align 16
  %49 = insertvalue %"any[]" undef, ptr %varargslots33, 0
  %"$$temp34" = insertvalue %"any[]" %49, i64 1, 1
...
; Function Attrs: nounwind ssp uwtable
define weak_odr <2 x i64> @"std_hash_siphash$uint128$2$4$.SipHash.final"(ptr %0) #0 comdat !dbg !78 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
checkok41:                                        ; preds = %checkok29
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %14, ptr align 8 %indirectarg43), !dbg !90
  ...
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %17), !dbg !92
  %18 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %18), !dbg !92
  %19 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %19), !dbg !92
  %20 = load ptr, ptr %self, align 8, !dbg !92
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %20), !dbg !92
    #dbg_declare(ptr %lo, !93, !DIExpression(), !94)
  %21 = load ptr, ptr %self, align 8, !dbg !94
  %22 = load i64, ptr %21, align 8, !dbg !94
  %23 = load ptr, ptr %self, align 8, !dbg !94
  %ptradd45 = getelementptr inbounds i8, ptr %23, i64 8, !dbg !94
  %24 = load i64, ptr %ptradd45, align 8, !dbg !94
  %xor46 = xor i64 %22, %24, !dbg !94
  %25 = load ptr, ptr %self, align 8, !dbg !94
  %ptradd47 = getelementptr inbounds i8, ptr %25, i64 16, !dbg !94
  %26 = load i64, ptr %ptradd47, align 8, !dbg !94
  %xor48 = xor i64 %xor46, %26, !dbg !94
  %27 = load ptr, ptr %self, align 8, !dbg !94
  %ptradd49 = getelementptr inbounds i8, ptr %27, i64 24, !dbg !94
  %28 = load i64, ptr %ptradd49, align 8, !dbg !94
  %xor50 = xor i64 %xor48, %28, !dbg !94
  store i64 %xor50, ptr %lo, align 8, !dbg !94
  %29 = load ptr, ptr %self, align 8, !dbg !95
  %ptradd51 = getelementptr inbounds i8, ptr %29, i64 8, !dbg !95
  %30 = load i64, ptr %ptradd51, align 8, !dbg !95
  %xor52 = xor i64 %30, 221, !dbg !95
  store i64 %xor52, ptr %ptradd51, align 8, !dbg !95
  %31 = load ptr, ptr %self, align 8, !dbg !96
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %31), !dbg !96
  %32 = load ptr, ptr %self, align 8, !dbg !96
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %32), !dbg !96
  %33 = load ptr, ptr %self, align 8, !dbg !96
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %33), !dbg !96
  %34 = load ptr, ptr %self, align 8, !dbg !96
  call void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %34), !dbg !96
  %35 = load i64, ptr %lo, align 8, !dbg !97
  %zext = zext i64 %35 to i128, !dbg !97
  %36 = load ptr, ptr %self, align 8, !dbg !97
  %37 = load i64, ptr %36, align 8, !dbg !97
  %38 = load ptr, ptr %self, align 8, !dbg !97
  %ptradd53 = getelementptr inbounds i8, ptr %38, i64 8, !dbg !97
  %39 = load i64, ptr %ptradd53, align 8, !dbg !97
  %xor54 = xor i64 %37, %39, !dbg !97
  %40 = load ptr, ptr %self, align 8, !dbg !97
  %ptradd55 = getelementptr inbounds i8, ptr %40, i64 16, !dbg !97
  %41 = load i64, ptr %ptradd55, align 8, !dbg !97
  %xor56 = xor i64 %xor54, %41, !dbg !97
  %42 = load ptr, ptr %self, align 8, !dbg !97
  %ptradd57 = getelementptr inbounds i8, ptr %42, i64 24, !dbg !97
  %43 = load i64, ptr %ptradd57, align 8, !dbg !97
  %xor58 = xor i64 %xor56, %43, !dbg !97
  %zext59 = zext i64 %xor58 to i128, !dbg !97
  %shl = shl i128 %zext59, 64, !dbg !97
  %44 = freeze i128 %shl, !dbg !97
  %or = or i128 %zext, %44, !dbg !97
  store i128 %or, ptr %taddr60, align 16
  %45 = load <2 x i64>, ptr %taddr60, align 16
  ret <2 x i64> %45
...
panic:                                            ; preds = %entry
  ...
  call void %46(ptr align 8 %indirectarg, ptr align 8 %indirectarg1, ptr align 8 %indirectarg2, i32 113) #5, !dbg !84
  unreachable, !dbg !84
...
panic13:                                          ; preds = %cond.phi
  ...
  store %any %50, ptr %ptradd18, align 16
...
panic21:                                          ; preds = %checkok20
  ...
  %54 = insertvalue %"any[]" undef, ptr %varargslots26, 0
  %"$$temp27" = insertvalue %"any[]" %54, i64 1, 1
...
; Function Attrs: nounwind ssp uwtable
define internal void @"std_hash_siphash$uint128$2$4$.SipHash.round"(ptr %0) #0 !dbg !98 {
entry:
  %indirectarg = alloca %"char[]", align 8
  %indirectarg1 = alloca %"char[]", align 8
  %indirectarg2 = alloca %"char[]", align 8
...
; Function Attrs: nounwind ssp uwtable
define weak_odr <2 x i64> @"std_hash_siphash$uint128$2$4$.hash"(ptr align 8 %0, ptr align 16 %1) #0 comdat !dbg !131 {
entry:
  ...
  %result = alloca i128, align 16
    ...
    #dbg_declare(ptr %1, !136, !DIExpression(), !135)
    #dbg_declare(ptr %s, !137, !DIExpression(), !138)
  call void @llvm.memset.p0.i64(ptr align 8 %s, i8 0, i64 56, i1 false), !dbg !138
  %2 = load i128, ptr %1, align 16
  store i128 %2, ptr %indirectarg, align 16
  call void @"std_hash_siphash$uint128$2$4$.SipHash.init"(ptr %s, ptr align 16 %indirectarg), !dbg !139
  call void @llvm.memcpy.p0.p0.i32(ptr align 8 %indirectarg1, ptr align 8 %0, i32 16, i1 false)
  call void @"std_hash_siphash$uint128$2$4$.SipHash.update"(ptr %s, ptr align 8 %indirectarg1), !dbg !140
  %3 = call <2 x i64> @"std_hash_siphash$uint128$2$4$.SipHash.final"(ptr %s), !dbg !141
...
!1 = distinct !DIGlobalVariable(name: "BLOCK_ROUNDS", linkageName: "std_hash_siphash$uint128$2$4$.BLOCK_ROUNDS", scope: !2, file: !2, line: 40, type: !3, isLocal: false, isDefinition: true, align: 4)
!2 = !DIFile(filename: "siphash.c3", directory: "C:/Compilers/C3/lib/std/hash")
!3 = !DIBasicType(name: "int", size: 32, encoding: DW_ATE_signed)
!4 = !DIGlobalVariableExpression(var: !5, expr: !DIExpression())
!5 = distinct !DIGlobalVariable(name: "FINALIZE_ROUNDS", linkageName: "std_hash_siphash$uint128$2$4$.FINALIZE_ROUNDS", scope: !2, file: !2, line: 40, type: !3, isLocal: false, isDefinition: true, align: 4)
...
!13 = !{!0, !4}
!14 = distinct !DISubprogram(name: "init", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.init", scope: !2, file: !2, line: 70, type: !15, scopeLine: 70, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!50 = distinct !DISubprogram(name: "update", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.update", scope: !2, file: !2, line: 89, type: !51, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!78 = distinct !DISubprogram(name: "final", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.final", scope: !2, file: !2, line: 113, type: !79, scopeLine: 113, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
!79 = !DISubroutineType(types: !80)
!80 = !{!81, !17}
!81 = !DIDerivedType(tag: DW_TAG_typedef, name: "OutType", scope: !2, file: !2, line: 40, baseType: !30, align: 16)
...
!98 = distinct !DISubprogram(name: "round", linkageName: "std_hash_siphash$uint128$2$4$.SipHash.round", scope: !2, file: !2, line: 145, type: !99, scopeLine: 145, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !12, retainedNodes: !31)
...
!131 = distinct !DISubprogram(name: "hash", linkageName: "std_hash_siphash$uint128$2$4$.hash", scope: !2, file: !2, line: 62, type: !132, scopeLine: 62, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !12, retainedNodes: !31)
!132 = !DISubroutineType(types: !133)
!133 = !{!81, !53, !30}
!134 = !DILocalVariable(name: "data", arg: 1, scope: !131, file: !2, line: 62, type: !53)
!135 = !DILocation(line: 62, scope: !131)
!136 = !DILocalVariable(name: "key", arg: 2, scope: !131, file: !2, line: 62, type: !30)
!137 = !DILocalVariable(name: "s", scope: !131, file: !2, line: 64, type: !18, align: 8)
!138 = !DILocation(line: 64, scope: !131)
!139 = !DILocation(line: 65, scope: !131)
!140 = !DILocation(line: 66, scope: !131)
!141 = !DILocation(line: 67, scope: !131)
