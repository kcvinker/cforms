...
@"std_math_complex$float$.IDENTITY" = weak_odr local_unnamed_addr constant { %.anon } { %.anon { float 1.000000e+00, float 0.000000e+00 } }, comdat, align 8, !dbg !0
@"std_math_complex$float$.IMAGINARY" = weak_odr local_unnamed_addr constant { %.anon } { %.anon { float 0.000000e+00, float 1.000000e+00 } }, comdat, align 8, !dbg !16
...
@"$ct.dyn.std_math_complex$float$.Complex.to_format" = weak_odr global { ptr, ptr, ptr } { ptr @"std_math_complex$float$.Complex.to_format", ptr @"$sel.to_format", ptr inttoptr (i64 -1 to ptr) }, comdat, align 8
@"$sel.to_format" = linkonce_odr constant [10 x i8] c"to_format\00", comdat, align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 1, ptr @.c3_dynamic_register, ptr null }]

; Function Attrs: nounwind ssp uwtable
define weak_odr i64 @"std_math_complex$float$.Complex.to_format"(ptr %0, ptr %1, ptr %2) #0 comdat !dbg !26 {
entry:
...
checkok:                                          ; preds = %entry
  ...
  %7 = insertvalue %any %6, i64 ptrtoint (ptr @"$ct.float" to i64), 1, !dbg !59
  store %any %7, ptr %varargslots, align 16, !dbg !59
  %8 = load ptr, ptr %self, align 8, !dbg !59
  %ptradd = getelementptr inbounds i8, ptr %8, i64 4, !dbg !59
  %9 = insertvalue %any undef, ptr %ptradd, 0, !dbg !59
  %10 = insertvalue %any %9, i64 ptrtoint (ptr @"$ct.float" to i64), 1, !dbg !59
...
entry:
  %next_val = load ptr, ptr getelementptr inbounds ({ ptr, ptr, ptr }, ptr @"$ct.dyn.std_math_complex$float$.Complex.to_format", i32 0, i32 2), align 8
  %0 = icmp eq ptr %next_val, inttoptr (i64 -1 to ptr)
  br i1 %0, label %dtable_check, label %dtable_skip

dtable_check:                                     ; preds = %dtable_check, %entry
  %dtable_ref = phi ptr [ getelementptr inbounds (%.introspect, ptr @"$ct.std_math_complex$float$.Complex", i32 0, i32 2), %entry ], [ %next_dtable_ref, %dtable_check ]
...
dtable_found:                                     ; preds = %dtable_check
  ...
  store ptr null, ptr getelementptr inbounds ({ ptr, ptr, ptr }, ptr @"$ct.dyn.std_math_complex$float$.Complex.to_format", i32 0, i32 2), align 8
...
!25 = !{!0, !16}
!26 = distinct !DISubprogram(name: "to_format", linkageName: "std_math_complex$float$.Complex.to_format", scope: !2, file: !2, line: 63, type: !27, scopeLine: 63, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !24, retainedNodes: !54)
